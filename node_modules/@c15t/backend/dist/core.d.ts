...
export declare const c15tInstance: <PluginTypes extends C15TPlugin[] = C15TPlugin[]>(options: C15TOptions<PluginTypes>) => {
    ...
    router: {
        consent: {
            ...
            showBanner: import("@orpc/server").Procedure<import("@orpc/server").MergedInitialContext<Record<never, never>, Record<never, never>, Record<never, never>>, Record<never, never>, import("@orpc/contract").Schema<unknown, unknown>, import("zod").ZodObject<{
                ...
                translations: import("zod").ZodObject<{
                    ...
                    translations: import("zod").ZodUnion<readonly [import("zod").ZodObject<{
                        ...
                        legalLinks: import("zod").ZodObject<{
                            privacyPolicy: import("zod").ZodString;
                            termsOfService: import("zod").ZodString;
                            cookiePolicy: import("zod").ZodString;
                        }, import("zod/v4/core").$strip>;
                    }, import("zod/v4/core").$strip>, import("zod").ZodObject<{
                        common: import("zod").ZodObject<{
                        ...
                        legalLinks: import("zod").ZodOptional<import("zod").ZodObject<{
                            privacyPolicy: import("zod").ZodOptional<import("zod").ZodOptional<import("zod").ZodString>>;
                            termsOfService: import("zod").ZodOptional<import("zod").ZodOptional<import("zod").ZodString>>;
                            cookiePolicy: import("zod").ZodOptional<import("zod").ZodOptional<import("zod").ZodString>>;
                        }, import("zod/v4/core").$strip>>;
                    }, import("zod/v4/core").$strip>]>;
                }, import("zod/v4/core").$strip>;
            ...
            identify: import("@orpc/server").Procedure<import("@orpc/server").MergedInitialContext<Record<never, never>, Record<never, never>, Record<never, never>>, Record<never, never>, import("zod").ZodObject<{
