 ...
 */
export declare function consentRegistry({ adapter, ...ctx }: RegistryContext): {
    /**
     ...
     */
    createConsent: (consent: Omit<Consent, "id" | "createdAt"> & Partial<Consent>, context?: GenericEndpointContext) => Promise<{
        id: string;
        subjectId: string;
        domainId: string;
        purposeIds: string[];
     ...
     * @see {@link GenericEndpointContext} For details on the context object
     */
    updateConsent: (consentId: string, data: Partial<Consent>, context?: GenericEndpointContext) => Promise<{
        id: string;
        subjectId: string;
        domainId: string;
        purposeIds: string[];
