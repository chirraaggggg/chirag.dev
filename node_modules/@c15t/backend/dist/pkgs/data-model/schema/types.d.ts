 ...
 */
export type PluginSchema = Record<string, {
    fields: Record<string, Field>;
    entityName?: string;
}>;
/**
 ...
 */
export type EntityInput<TEntity extends EntityName> = Partial<EntityTypeMap[TEntity]> & Record<string, unknown>;
/**
 ...
 */
export type EntityOutput<TEntity extends EntityName> = EntityTypeMap[TEntity] & Record<string, unknown>;
