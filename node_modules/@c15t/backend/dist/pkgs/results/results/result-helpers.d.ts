...
import type { ErrorMessageType, ErrorTransformer, SDKResult, SDKResultAsync } from '../types';
/**
 ...
 * ```
 */
export declare function fail<TValue>(message: string, options: ConstructorParameters<typeof DoubleTieError>[1]): SDKResult<TValue>;
/**
 ...
 * ```
 */
export declare function failAsync<TValue>(message: string, options: ConstructorParameters<typeof DoubleTieError>[1]): SDKResultAsync<TValue>;
/**
 ...
 * ```
 */
export declare function tryCatch<TValue>(fn: () => TValue, errorCode?: ErrorMessageType, errorMapper?: ErrorTransformer): SDKResult<TValue>;
/**
 ...
 * ```
 */
export declare function tryCatchAsync<TValue>(fn: () => Promise<TValue>, errorCode?: ErrorMessageType, errorMapper?: ErrorTransformer): SDKResultAsync<TValue>;
/**
 ...
 * ```
 */
export declare function promiseToResult<TValue>(promise: Promise<TValue>, errorCode?: ErrorMessageType): SDKResultAsync<TValue>;
