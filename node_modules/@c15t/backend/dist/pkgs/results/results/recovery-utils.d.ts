 ...
 * ```
 */
export declare const withFallbackForCodes: <TValue>(result: SDKResult<TValue>, errorCodes: ErrorMessageType[], defaultValue: TValue) => SDKResult<TValue>;
/**
 ...
 * ```
 */
export declare const withFallbackForCategory: <TValue>(result: SDKResult<TValue>, category: ErrorCategory, defaultValue: TValue) => SDKResult<TValue>;
//# sourceMappingURL=recovery-utils.d.ts.map