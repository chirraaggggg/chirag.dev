 ...
 * ```
 */
export declare function createErrorCategories<TCategories extends Record<string, string>>(categories: TCategories): Readonly<TCategories>;
/**
 ...
 * ```
 */
export declare function createErrorCodes<TCodes extends Record<string, string>>(codes: TCodes): Readonly<TCodes>;
