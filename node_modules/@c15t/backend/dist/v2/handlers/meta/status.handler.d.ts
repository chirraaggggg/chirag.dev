export declare const statusHandler: import("@orpc/server").ImplementedProcedure<Record<never, never>, Record<never, never>, import("@orpc/contract").Schema<unknown, unknown>, import("zod").ZodObject<{
