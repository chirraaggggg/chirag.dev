...
type ContractTestHelpers = {
    ...
    testOutput: (testName: string, output: unknown, shouldBeValid: boolean) => void;
    testDiscriminatedUnion: (discriminator: string, validValues: string[]) => void;
 ...
 */
export declare function createContractTests(contractName: string, contract: {
    '~orpc'?: {
 ...
 */
export declare function createConsistencyTests(contracts: Record<string, {
    '~orpc'?: {
        inputSchema?: ContractSchema;
        outputSchema?: ContractSchema;
    };
