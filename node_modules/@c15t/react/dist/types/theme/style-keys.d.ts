...
export type AllThemeKeys = NestedKeys<CookieBannerTheme> | NestedKeys<ConsentManagerWidgetTheme> | NestedKeys<ConsentManagerDialogTheme> | NestedKeys<FrameTheme> | NestedKeys<AccordionStylesKeys> | NestedKeys<SwitchStylesKeys> | NestedKeys<{
    button: ThemeValue;
}>;
export {};
