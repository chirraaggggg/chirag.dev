...
function dbToSchemaType(dbType, provider, additional) {
...
var supportJson = ["postgresql", "cockroachdb", "mysql"];
function deserialize(value, col, provider) {
  if (value === null) return null;
  if (!supportJson.includes(provider) && col.type === "json" && typeof value === "string") {
    return JSON.parse(value);
  }
  if (provider === "sqlite" && (col.type === "timestamp" || col.type === "date") && (typeof value === "number" || typeof value === "string")) {
